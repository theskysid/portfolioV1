...
export default function FaultyTerminal({
  ...
  const timeOffsetRef = useRef(-1); // seeded in the effect; Math.random() during render is impure

  // Assigning in an effect, not during render: mutating a ref while rendering is impure.
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // window, not ctn: the container is a full-page backdrop sitting *behind*
    // the content, so it never receives pointer events of its own.
